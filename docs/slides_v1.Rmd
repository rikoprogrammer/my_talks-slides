...
- Data analytics - The science of analyzing raw data to make informed decisions. Many of the techniques and processes of data analytics have been automated into efficient processes and algorithms that can work with raw data in order to extract meaningful information from massive amounts of data.
...
Early forms of evaluation of the effect of food on body strength and health in general were done during Biblical times as well during the reign of King Nebuchadnezzar. (Daniel Chap 1 : 12 - 15).
...
Data collection process -  eCRF (electronic case report forms) design, collect raw data, standardize data by reorganizing it per topic of interest eg adverse events (SDTM domains).
